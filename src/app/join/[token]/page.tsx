...
export default function JoinPage() {
  ...
  // ----- Peek failed -----
  if (!peek.ok) {
    const copyTitle = t(`fail.${peek.reason}.title`);
    const copyBody = t(`fail.${peek.reason}.body`);
    return (
      <Card className="w-full max-w-md border-border bg-card">
        <CardHeader className="items-center text-center">
          ...
          <CardTitle className="text-xl text-foreground">{copyTitle}</CardTitle>
